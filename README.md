...
This step builds the paper tree using the parsed files in the `files` directory. For a demonstration of this step, refer to the <font color=red>**Paper Tree Building Demo Video**</font>.<span style="color: #FF5733;">这是带有颜色的文本</span>
